    ...
    <section className="relative h-[600px] flex items-center justify-center bg-muted overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-light tracking-tight text-foreground mb-6">
          MODULAR FURNITURES DESIGNED BY YOU,
          <br />
          BUILT BY BYTRAS
        </h1>

        <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
          Upload your space. Describe your vision. Get modular—kitchens, wardrobes, lofts, beds, and storage, crafted
          from 100% recycled polymer panels Designed, Built and Installed to your style.
        </p>
        ...
        <Button
          ...
          onClick={() =>
            document.getElementById("design-studio")?.scrollIntoView({
              behavior: "smooth",
            })
          }
        >
